...
app.controller('CarController', function ($scope){
	$scope.cars= {
		"Audi":{"make":"Audi", "model":"A3 Series"}, 
		"BMW":{"make":"BMW", "model":"1 Series"}, 
		"Mercedes":{"make":"Mercedes", "model":"A Series"}, 
		"Tesla":{"make":"Tesla", "model":"Model 3"}
		};
	$scope.description = "Brand new";
});
...
//var app2 = angular.module("instantSearch", []);
